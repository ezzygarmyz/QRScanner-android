...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if (pythonApp != null && pythonApp.containsKey("onBackPressed")) {
            PyObject pyResult = pythonApp.callAttr("onBackPressed");
            if (pyResult != null && pyResult.toBoolean() == true) {
                return;
            }
        }
        super.onBackPressed();
        userCode("onBackPressed");
    }
